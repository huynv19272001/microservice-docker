...
public class PayBillPartialReq extends AbstractBody{
    ...
    public PayBillPartialReq(String mcRequestId, String serviceCode, String publisher, String customerCode, List<Payment> billPayment){
    ...
    public static class OthInfo extends AbstractBody {
        ...
        @JsonProperty(value = "partial", required = true)
        ...
        public OthInfo(String creationDate, String expirationDate, String payDate, String addFee, String partial, String minAmount, String channelSource, String fullName, String phone, String relative){
