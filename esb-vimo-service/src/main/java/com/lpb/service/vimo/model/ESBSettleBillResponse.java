...
public class ESBSettleBillResponse extends AbstractBody{
        public ESBSettleBillResponse(){
    ...
    public static class DATA extends AbstractBody {
        ...
        private ESBSettleBillRequest.Body body;

        @JsonProperty(value = "header", required = false)
        private ESBSettleBillRequest.Header header;

        public ESBSettleBillRequest.Body getBody() {
            return body;
        }

        public void setBody(ESBSettleBillRequest.Body body) {
            this.body = body;
        }

        public ESBSettleBillRequest.Header getHeader() {
            return header;
        }

        public void setHeader(ESBSettleBillRequest.Header header) {
            this.header = header;
        }
    }
