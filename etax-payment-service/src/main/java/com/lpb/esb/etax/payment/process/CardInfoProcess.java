...
import com.lpb.esb.etax.payment.model.data.LpbCard;
import com.lpb.esb.etax.payment.model.data.LpbCardInfo;
...
public class CardInfoProcess {
    ...
    public ResponseModel<LpbCard> inquiryCardInfo(String cardNumber) {
        ...
        try {
            ...
            if (!"0".equals(card.getEcom())) {
                resCode.setErrorCode(EtaxErrorConfig.ERROR_CODE_128);
                resCode.setErrorDesc(EtaxErrorConfig.ERROR_DESC_128);
                return response;
            }
            // return
