...
public class GeneralTransConfig {
    ...
    // SMS template
    public static final String PAYMENT_OTP_SMS = "Quy khach dang thuc hien nop thue qua tai khoan mo tai LPB. KHONG cung cap ma OTP cho bat cu ai de tranh rui ro MAT TIEN. Ma xac thuc OTP la %s";
