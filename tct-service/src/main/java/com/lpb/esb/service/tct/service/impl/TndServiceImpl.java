...
@Service
@Log4j2
public class TndServiceImpl implements TndService {
    @Autowired
    ...
    public ResponseModel search(RequestData requestData) {
        ...
        String body = buildMessageUtils.buildBodyTND(requestData);
        ...
        if (response.getStatusCode().intValue() == 200) {
            ...
            logicUtils.convertData(jsonObject, ModuleConfig.TND);
