...
@Service
@Log4j2
public class LptbServiceImpl implements LptbService {
    @Autowired
    ...
    @Override
    public ResponseModel search(RequestData requestData) throws Exception {
        ...
        String body = buildMessageUtils.buildBodyLPTB(requestData);
        ...
        if (response.getStatusCode().intValue() == 200) {
            ...
            logicUtils.convertData(jsonObject, ModuleConfig.LPTB);
