...
/**
 * Created by tudv1 on 2022-03-16
 */
@Service
@Log4j2
public class DanhmucServiceImpl implements DanhmucService {
    ...
    @Override
    public ResponseModel truyVanDanhMuc(RequestData requestData) {
        ...
        String body = buildMessageUtils.buildBodyDanhmucTruyvan(serviceInfo);
