...
@Service
@Log4j2
public class ThuNopMstServiceImpl implements ThuNopMstService {
    @Autowired
    ...
    public ResponseModel search(EsbTctRequestDTO requestData) throws Exception {
        ...
        String body = buildMessageUtils.buildBodyThuNopMst(tctRequestDTO);
        ...
        if (response.getStatusCode().intValue() == 200) {
            ...
            logicUtils.convertData(jsonObject, ModuleConfig.THUNOPMST);
