...
//@Log4j2
//@Service
//public class DangKyBdsdQuaNotificationServiceV0Impl implements DangKyBdsdQuaNotificationServiceV0 {
//    @Autowired
//    LvtClient lvtClient;
//    @Autowired
...
//        Execute lvtRequest = new Execute();
//        lvtRequest.setUser(user);
//        lvtRequest.setRequestData(lvtRequestData);
//        JAXBElement<ExecuteResponse> lvtResponse = lvtClient.sendRequest(lvtRequest, url);
//        String lvtResponseData = lvtResponse.getValue().getReturn().getResponseData();
//        log.info("Message ID: " + msgId + " | LVT ResponseData: " + lvtResponseData);
//
//        XmlMapper xmlMapper = new XmlMapper();
//        ResponseHeader jsonLvtResData = xmlMapper.readValue(lvtResponseData, Response.class).getResponseHeader();
//
