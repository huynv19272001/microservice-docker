...
public class FTPSServiceImpl implements FTPSService {
    ...
    private FTPSClient initFTPClient(FTPSClient ftpClient, ServiceInfo serviceInfo, BaseRequestDTO request) {
        try {
    ...
    private void closeFTPClient(FTPSClient ftpClient, BaseRequestDTO request) {
        try {
            ftpClient.logout();
            ftpClient.disconnect();
        } catch (Exception e) {
