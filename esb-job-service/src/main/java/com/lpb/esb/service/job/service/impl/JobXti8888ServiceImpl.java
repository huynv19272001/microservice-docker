...
@Service("jobXti8888ServiceImpl")
@Log4j2
public class JobXti8888ServiceImpl implements JobScheduleService {
    @Value("${job.xti.8888:JOB_XTI_8888}")
    String jobName;
    @Autowired
    ...
    @Scheduled(fixedDelay = 1000 * 20, initialDelay = 1000 * 2)
    @Override
