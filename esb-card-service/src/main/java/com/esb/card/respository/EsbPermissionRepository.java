...
import com.esb.card.model.EsbPermission;
...
public interface EsbPermissionRepository extends JpaRepository<EsbPermission, String> {
    ...
    @Query("SELECT new com.esb.card.dto.ServiceInfoDTO(b.serviceId , c.productCode, c.urlApi, c.connectorUrl, c.connectorPort, c.methodAction, c.udf1, c.udf2, c.udf3, c.udf4) " +
