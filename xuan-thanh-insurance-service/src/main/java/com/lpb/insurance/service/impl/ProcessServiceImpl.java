...
import com.lpb.insurance.dto.request.healthinsurance.HealthInsuranceDTO;
import com.lpb.insurance.dto.request.homeinsurance.HomeInsuranceDTO;
...
public class ProcessServiceImpl implements ProcessService {
    ...
    @Override
    public ResponseModel homeInsurance(EsbRequestDTO data) {
        ...
        try {
            HomeInsuranceDTO request = objectMapper.readValue(objectMapper.writeValueAsString(data.getBody().getData()), HomeInsuranceDTO.class);
...
//            log.info("REQ:" + request);
            ...
            log.error("HttpClientErrorException:" + data.getHeader().getMsgId() + "_" + e);
            e.printStackTrace();
            ErrorDTO errorCodeMessage = null;
            try {
                errorCodeMessage = objectMapper.readValue(e.getResponseBodyAsString(), ErrorDTO.class);
            } catch (JsonProcessingException jsonEx) {
                log.error("JsonProcessingException: " + data.getHeader().getMsgId() + "_" + e);
                e.printStackTrace();
            }
    ...
    @Override
    public ResponseModel healthCreditInsurance(EsbRequestDTO data) {
        log.info("MSGREQ:" + data);
        ObjectMapper objectMapper = new ObjectMapper();
        ...
        try {
            HealthInsuranceDTO request = objectMapper.readValue(objectMapper.writeValueAsString(data.getBody().getData()), HealthInsuranceDTO.class);
            log.info("REQ:" + request);
